...
public class MessageType implements java.io.Serializable {
    ...
    public static final MessageType ENGLISH = new MessageType(_ENGLISH);
    public static final MessageType UNICODE = new MessageType(_UNICODE);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://ws.srisairam.org/", "messageType"));
    }
    /**
